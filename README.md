...
You can use jsdelivr.net to get the latest modules. For example the module generic_map.js can be accessed in your javascript with (assuming a commit tag of 2.0.7 exists for this repo)

import { setup_generic_map } from "https://cdn.jsdelivr.net/gh/vytools/vyjs@v2.0.7/js/generic_map.js";
